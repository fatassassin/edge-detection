function []=jpg2plt(jpg_file)


G1=imread(jpg_file);%读取jpg格式的图像文件，matlab以数组形式保存在内存中
...
%figure(5);
%imshow(conturIm)
[fitlines, conturIm] = bwCt_LFt(G3, 2, 1);%主要算法实现的子函数，返回值conturIm为轮廓图像，fitlines是轮廓曲线的拟合线段的集合，
